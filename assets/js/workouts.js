    ...
    exercises: [
      {
        ...
        tip: "Na multiestação Body-Solid. Escápulas para trás, peito aberto. Empurre sem travar o cotovelo.",
      },
      {
        id: "a2",
      ...
      },
      {
        ...
        rest: 60,
        gif: "Pack deck.gif",
        tip: "Opcional leve. Amplitude confortável nos ombros.",
      },
    ],
    extras: [],
  },
    ...
    exercises: [
      {
        ...
        reps: "10–12",
        rest: 90,
        photo: "aparelhos/puxada-peito.jpg",
        tip: "Puxe com as costas. Imagine colocar os ombros no bolso de trás — sem balançar.",
      },
      {
        id: "b2",
        name: "Remada (máquina ou unilateral)",
        sets: 3,
        reps: "10–12",
        rest: 75,
        photo: "aparelhos/multiestacao.jpg",
        tip: "Na multiestação ou com halter. No topo, aperte a escápula. Isso fortalece a postura.",
      },
      {
        id: "b3",
    ...
    exercises: [
      {
        ...
        rest: 90,
        photo: "aparelhos/smith-polia.jpg",
        tip: "No Smith (tem a espuminha na barra) ou no banco. Empurre o calcanhar, aperte o glúteo no topo. Não arqueie demais a lombar.",
      },
      {
        id: "c2",
